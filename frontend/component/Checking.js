...
// import HoverMaskWaterReveal from "./about/HoverMaskWaterReveal.jsx";
...
const functionCards = [
  ...
  {
    label: "Dive Modes",
    title: "1:1 with founders \u00B7 Core teams",
    description:
...
export default function Home_contant() {
  ...
  return (
    <>
      ...
      <section className="checking-section home-checking-section">
        <div className="checking-container home-checking-container">
          <motion.div
            className="checking-sticky-panel home-checking-sticky-panel"
            {...leftReveal}
          >
            <div className="headline ocean-headline">
              <div className="ocean-copy">
                <div className="ocean-kicker">
                  <span>Sound Engineer</span>
                  <span className="ocean-kicker-separator" aria-hidden="true">
                    &middot;
                  </span>
                  ...
                  <span>Certified Diver</span>
                </div>
  
                <h2 className="ocean-title font-serif">
                  A Deep-Ocean Guide for Branding &amp; Business.
                </h2>
  
                <div className="ocean-body">
                  <p>
                    The ocean is your brand: vast, complex, and full of invisible
                    currents.
                  </p>
                  <p>
                    I dive with you, bringing clarity, strategy, and creative
                    systems so you can move with intent, not noise.
                  </p>
                </div>
  
                <div className="ocean-actions">
                  <a href="#contact" className="ocean-cta">
                    Book a strategy
                  </a>
                </div>
              </div>
          ...
          <div className="checking-scroll-container home-checking-scroll-container">
            {functionCards.map((card) => (
              <div key={card.label} className="checking-card-stage home-checking-card-stage">
                <motion.article
                  className={`checking-card home-checking-card${
                    card.tone ? ` ${card.tone}` : ""
                  }`}
                ...
                >
                  <div className="checking-card-content">
                    <p className="checking-card-label">{card.label}</p>
                    <h3 className="checking-card-title">{card.title}</h3>
                    <p className="checking-card-description">{card.description}</p>
                  </div>
                </motion.article>
              </div>
            ))}
